...
window.AICLAB_DATA = {
  ...
  "advisor": {
    "bio": [
      "<strong><em>Chung-Chih Hung (M'98-SM'07)</em></strong> received the B.S. degree in electrical engineering from National Taiwan University, Taipei, Taiwan, in 1989, and the M.S. and Ph.D. degrees in electrical engineering from The Ohio State University, Columbus, Ohio in 1993 and 1997, respectively.",
      "&emsp;From 1997 to 2003, he worked for several IC design companies in San Jose, CA and San Diego, CA, where he held analog circuit design manager and director positions and successfully designed many chips in mass production. Since 2003, he has been with National Chiao Tung University (NCTU), Hsinchu, Taiwan, where he is currently a Professor in the Department of Electrical and Computer Engineering. He is the Co-Director of the <a href='https://betrc.eic.nycu.edu.tw/' target='_blank' rel='noopener noreferrer'>Biomedical Electronics Translational Research Center (BETRC)</a> , where several highlighted bio-electronics papers were published in recent ISSCC and VLSI Circuit Symposiums. Dr. Hung was the Chairman of <a href='https://ece.nycu.edu.tw/eng/content/index.aspx?Parser=1,11,133,93,109,194' target='_blank' rel='noopener noreferrer'>Electrical Engineering and Computer Science Undergraduate Honors Program (EECSHP)</a> in NCTU. He has served on the Steering Committees of the IEEE MWSCAS and technical program committees of several IEEE conferences. He and his students have won 3 Best Paper Awards at international conferences in 2010, 2013, and 2015. He has been the Deputy Editor-In-Chief of Analog Integrated Circuits and Signal Processing since 2013. Dr. Hung has authored/co-authored over 100 peer-reviewed papers and book chapters and holds several US patents. His research interests include the design of analog and mixed-signal integrated circuits for biomedical, power management, and communication applications."
    ],
    "education": [
        {
            "degree": "Ph.D.",
